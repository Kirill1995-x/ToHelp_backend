...
{
	$sql="INSERT INTO request_to_specialist (type_of_request, subject_of_country, status, id_of_user, message_of_user, TIME_sent_user, DATE_sent_user)
		  VALUES ('".$type_of_request."', '".$subject_of_country."','".$status."','".$id_of_user."','".$message."','".$time."','".$date."')";
