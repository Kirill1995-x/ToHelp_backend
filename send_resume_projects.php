...
$projects=mysqli_real_escape_string($con,$_POST["projects"]);
$response=array();
...
if(check_access_token($id, $access_token, $con))
{
	...
	{
		$sql="UPDATE resume SET projects='".$projects."' WHERE id='".$id."';";
	}
	else
	{
		$sql="INSERT INTO resume (id, projects) VALUES ('".$id."', '".$projects."');";
	}
